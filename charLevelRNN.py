...
INPUT_FILE = sys.argv[1] #r'D:\source\Linux\word2vec\trunk\text8'
#INPUT_FILE = r'D:\source\Linux\word2vec\trunk\LICENSE'
OUTPUT_FILE = sys.argv[2] #r'log.txt'
INFINITE_LOOP = True
ITERATIONS = 100000
...
def main():
    ...
    smooth_loss = -np.log(1.0/vocab_size) * seq_length # loss at iteration 0    # what is this smooth loss???
    while True:
