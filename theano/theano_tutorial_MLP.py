...
'''
http://nbviewer.jupyter.org/github/craffel/theano-tutorial/blob/master/Theano%20Tutorial.ipynb#Theano-Tutorial
'''
    ...
    def __init__(self, W_init, b_init, activation):
        ...
        :parameters:
            ...
            - activation: theano.tensor.elemwise.Elemwise
                Activation function for layer outp
        '''
        ...
        self.b = theano.shared(value=b_init.reshape(n_output, 1).astype(theano.config.floatX),
                               ...
                               # By setting braodcastable=(False, True), we are denoting that b
                               # can be braodcast (copied) along its second dimension in order to be
...
class MLP(object):
    def __init__(self, W_init, b_init, activations):
        ...
        :parameters:
            ...
            - b_init: list of np.ndarray, len=NameError
...
def main():
    # Training data - two randomly-generated Gaussion-distributed clouds of points in 2d space
    np.random.seed(0)
    # Number of points
    N = 1000
